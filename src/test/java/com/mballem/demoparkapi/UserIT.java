...
public class UserIT {
    ...
    @Test
    public void findUser_WithUserClientSearchingOtherClient_ReturnErrorMessageWithStatus403() {
        ErrorMessage responseBody = testClient
                .get()
    ...
    @Test
    public void updatePassword_WhitValidData_ReturnStatus204() {
        testClient
                .patch()
                .uri("/api/v1/users/100")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void updatePassword_WithDifferentUser_ReturnErrorMessageWithStatus403() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/users/0")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void updatePassword_WithInvalidFields_ReturnErrorMessageWithStatus422() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/users/100")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void updatePassword_WithValidPassword_ReturnErrorMessageWithStatus400() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/users/100")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void listUsers_WithUserWithPermission_ReturnListOfUsersWithStatus200() {
    ...
    @Test
    public void listUsers_WithUserWithoutPermission_ReturnErrorMessageWithStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/users")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
